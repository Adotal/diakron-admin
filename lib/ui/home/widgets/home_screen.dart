...
import 'package:diakron_admin/ui/auth/logout/view_models/logout_viewmodel.dart';
import 'package:diakron_admin/ui/auth/logout/widgets/logout_button.dart';
          ...
          builder: (context, _) {
            return Column(
              ...
              children: [
                ...
                LineChartSection(
                  title: widget.viewModel.currentChartTitle, // Función dinámica
